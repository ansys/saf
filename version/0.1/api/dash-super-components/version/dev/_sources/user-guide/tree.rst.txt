...
.. image:: ../media/tree/example_output.png
    :align: center
...
.. literalinclude:: ../../../examples/user_guide/example_tree.py
   :language: python
...
.. image:: ../media/tree/default_configuration.png
    :align: center
...
.. literalinclude:: ../../../examples/user_guide/example_tree_multipage.py
   :language: python
...
.. image:: ../media/tree/custom_configuration.png
    :align: center
...
.. image:: ../media/tree/styled_tree.png
    :align: center
...
.. grid:: 3
   ...
   .. grid-item::
      ...
      .. figure:: ../media/tree/dark_mode_options_light.png
         :align: center
   ...
   .. grid-item::
      ...
      .. figure:: ../media/tree/dark_mode_options_dark.png
         :align: center
...
============== ======================================================= ======= ========
id             The unique identifier of the item.                      string  Yes
text           The text displayed in the item.                         string  Yes
icon           The icon value displayed for the item. Supports         string  No
               local image values (for example, ``/assets/...``
               or base64 data URI values) and Iconify icon names.
               See :ref:`ref_icons` for details.
``icon_color`` Optional CSS color for the item icon. If omitted,       string  No
               the icon inherits ``currentColor``.
``icon_type``  Explicit icon rendering mode: ``"auto"``,               string  No
               ``"local"``, or ``"iconify"``.
               Default: ``"auto"``.
expanded       Controlled nested items collapse state.                 boolean No
               Sets the initial open/closed state on load.
               Default: ``False`` (collapsed)
disabled       Turn off item selection.                                boolean No
               Default: ``False`` (enabled)
description    The item description added below the text.              string  No
               Default: ``""`` (no description)
styles         A dictionary of styles applied to the NavLink           dict    No
               sub-components (for example, ``"label"``,
               ``"root"``). If ``styles["label"]["color"]`` is
               not set, it defaults to
               ``"var(--mantine-color-text)"``.
               Default:
               ``{"label": {"color": "var(--mantine-color-text)"}}``
               (default label color applied)
children       The list of children of the item.                       list    No
               If not provided, the item is considered a leaf
...
Key             Description                                                  Type    Required
=============== ============================================================ ======= ========
items           A list of dictionaries representing the tree structure.      list    Yes
selected_item   The unique id of the initially selected tree item.           string  No
                Default: ``None`` (no item selected)
default_icon    The default icon value displayed for tree items when         string  No
                ``icon`` is not provided. Supports local image values
                and Iconify icon names.
                Default: ``None`` (no icon rendered).
aio_id          The unique identifier for the component. If not provided,    string  No
                a UUID is generated.
=============== ============================================================ ======= ========
...
Check out this `example <https://github.com/ansys/super-components-for-dash/blob/main/examples/showcase_all/src/ansys/solutions/showcase_dash_super_components/ui/pages/tree_page.py>`_
...
<https://github.com/ansys/super-components-for-dash/blob/main/examples/showcase_all/src/ansys/solutions/showcase_dash_super_components/ui/pages/page.py>`_.
...
:ref:`sphx_glr_examples_general_example_tree.py` page in the Examples gallery.
...
Check out the `component source code <https://github.com/ansys/super-components-for-dash/blob/main/src/ansys/solutions/dash_super_components/tree.py>`_
