.. _user_guide_frontend_dash_super_components_usage_authenticator:
...
.. image:: /_static/dash-media/authenticator/example_output.png
   :width: 45%
...
.. literalinclude:: ../../../../../../../packages/dash-super-components/examples/user_guide/example_authenticator.py
   :language: python
...
.. image:: /_static/dash-media/authenticator/default_configuration.png
   :alt: Default configuration of the Authenticator component
   :width: 45%
...
:ref:`This table <authenticator_item_definition_properties>` lists the authorized keys for the
item definition.

The following output is expected:

.. image:: /_static/dash-media/authenticator/custom_configuration.png
   :alt: Custom configuration of the Authenticator component
   :width: 45%
...
.. _authenticator_item_definition_properties:
...
Check out this `example <https://github.com/ansys/saf/blob/main/packages/dash-super-components/examples/showcase_all/src/ansys/solutions/showcase_dash_super_components/ui/pages/authenticator_page.py>`_
...
:ref:`sphx_glr_examples_dash_super_components_examples_general_example_authenticator.py` page in the Examples gallery.
...
Check out the `component source code <https://github.com/ansys/saf/blob/main/packages/dash-super-components/src/ansys/solutions/dash_super_components/authenticator.py>`_
