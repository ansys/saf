.. _user_guide_frontend_dash_super_components_usage_dual_input_range_slider:
...
.. image:: /_static/dash-media/dual_input_range_slider/example_output.png
   :alt: Example output of the Dual Input Range Slider component
   :width: 55%
...
.. literalinclude:: ../../../../../../../packages/dash-super-components/examples/user_guide/example_dual_input_range_slider.py
   :language: python
...
.. image:: /_static/dash-media/dual_input_range_slider/default_configuration.png
   :alt: Default configuration of the Dual Input Range Slider component
   :width: 55%
...
.. image:: /_static/dash-media/dual_input_range_slider/custom_configuration.png
   :alt: Custom configuration of the Dual Input Range Slider component
   :width: 75%
...
<https://github.com/ansys/saf/blob/main/packages/dash-super-components/src/ansys/solutions/dash_super_components/dual_input_range_slider.py>`_.
...
:ref:`sphx_glr_examples_dash_super_components_examples_general_example_dual_input_range_slider.py` page in the Examples gallery.
...
Check out the `component source code <https://github.com/ansys/saf/blob/main/packages/dash-super-components/src/ansys/solutions/dash_super_components/dual_input_range_slider.py>`_
