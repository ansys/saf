...
.. image:: ../media/input_row_array/input_row_array_with_buttons.png
    :align: center
...
.. literalinclude:: ../../../examples/user_guide/example_input_row_array.py
   :language: python
...
.. image:: ../media/input_row_array/default_configuration.png
    :align: center
...
.. image:: ../media/input_row_array/custom_configuration.png
    :align: center
...
Check out this `example <https://github.com/ansys/super-components-for-dash/blob/main/examples/showcase_all/src/ansys/solutions/showcase_dash_super_components/ui/pages/input_row_array_page.py>`_
...
:ref:`sphx_glr_examples_general_example_input_row_array.py` page in the Examples gallery.
...
Check out the `component source code <https://github.com/ansys/super-components-for-dash/blob/main/src/ansys/solutions/dash_super_components/input_row_array.py>`_
