...
.. image:: ../media/logs_supervisor/example_output.png
    :align: center
...
.. literalinclude:: ../../../examples/user_guide/example_logs_supervisor.py
   :language: python
...
.. image:: ../media/logs_supervisor/default_configuration.png
    :align: center
...
.. image:: ../media/logs_supervisor/custom_configuration.png
    :align: center
...
.. literalinclude:: ../../../examples/user_guide/super_components_with_saf/src/ansys/solutions/super_components_with_saf/solution/my_step.py
   :language: python
...
.. note::
    ...
    Due to the way GLOW's BDM file handles work, a new log file handle must be created and uploaded each time the log file is updated. This is because BDM file handles are immutable, so the same file handle cannot be updated with the new content, but a new handle must be created for each
    update.
    ...
    <https://github.com/ansys/super-components-for-dash/blob/main/examples/showcase_all/src/ansys/solutions/showcase_dash_super_components/ui/pages/logs_supervisor_page.py>`_.
...
.. image:: ../media/logs_supervisor/saf_logs_supervisor_empty.png
    :align: center
...
.. image:: ../media/logs_supervisor/saf_logs_supervisor_populated.png
   :align: center
...
:ref:`sphx_glr_examples_general_example_logs_supervisor.py` page in the Examples gallery.
...
Check out the `component source code <https://github.com/ansys/super-components-for-dash/blob/main/src/ansys/solutions/dash_super_components/logs_supervisor.py>`_
