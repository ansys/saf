...
#. Run the solution with the ``--portal`` option.
#. Find the project to export, click the button for more options and click :guilabel:`Export project` or :guilabel:`Export as` if you want to use a different file name than the project name.
