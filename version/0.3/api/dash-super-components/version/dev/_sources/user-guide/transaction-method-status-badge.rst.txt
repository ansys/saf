.. _ref_transaction_method_status_badge:
...
.. image:: ../media/transaction_method_status_badge/badge_active_running.png
    :align: center
...
.. image:: ../media/transaction_method_status_badge/default_configuration.png
    :align: center
...
.. image:: ../media/transaction_method_status_badge/default_configuration_running.png
    :align: center
...
.. image:: ../media/transaction_method_status_badge/custom_configuration.png
    :align: center
...
3. **Monitoring State Visual Feedback**: The badge appearance changes to indicate whether it's
   ...
   .. figure:: ../media/transaction_method_status_badge/badge_active_running.png
       :align: center
       :figclass: align-center

       Badge in active monitoring state (filled, spinner shown)

   .. figure:: ../media/transaction_method_status_badge/badge_inactive_running.png
       :align: center
       :figclass: align-center
...
`showcase example <https://github.com/ansys/super-components-for-dash/blob/main/examples/showcase_all/src/ansys/solutions/showcase_dash_super_components/ui/pages/transaction_method_status_badge_page.py>`_.
...
:ref:`sphx_glr_examples_saf_based_example_transaction_method_status_badge.py` page in the
Examples gallery.
...
Check out the `component source code <https://github.com/ansys/super-components-for-dash/blob/main/src/ansys/solutions/dash_super_components/transaction_method_status_badge.py>`_
