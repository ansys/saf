.. _user_guide_frontend_dash_super_components_usage_transaction_supervisor:
...
.. image:: /_static/dash-media/transaction_supervisor/example_output.png
   :alt: Example output of the Transaction Supervisor
   :width: 40%
...
.. image:: /_static/dash-media/transaction_supervisor/default_configuration.png
   :alt: Default configuration of the Transaction Supervisor
   :width: 40%
...
.. image:: /_static/dash-media/transaction_supervisor/default_configuration_running.png
   :alt: Default configuration running of the Transaction Supervisor
   :width: 40%
...
.. image:: /_static/dash-media/transaction_supervisor/custom_configuration.png
   :alt: Custom configuration of the Transaction Supervisor
   :width: 40%
...
<https://github.com/ansys/saf/blob/main/packages/dash-super-components/src/ansys/solutions/dash_super_components/transaction_supervisor.py>`_.
...
:ref:`sphx_glr_examples_dash_super_components_examples_saf_based_example_transaction_supervisor.py` page in the Examples gallery.
...
Check out the `component source code <https://github.com/ansys/saf/blob/main/packages/dash-super-components/src/ansys/solutions/dash_super_components/transaction_supervisor.py>`_
